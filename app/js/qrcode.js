...
qrcode.decode = function(src){
    ...
    if(typeof(src) === "object") {
        ...
        qrcode.width = src.width;
        qrcode.height = src.height;
        ...
        image.onload=function(){
            ...
            self.canvas.width = nwidth;
            self.canvas.height = nheight;
            
            context.drawImage(image, 0, 0, self.canvas.width, self.canvas.height );
            qrcode.width = self.canvas.width;
            qrcode.height = self.canvas.height;
            try{
                qrcode.imagedata = context.getImageData(0, 0, self.canvas.width, self.canvas.height);
            }catch(e){
